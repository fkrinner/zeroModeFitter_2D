...
#	tBins = [3]
	...
	if True:
		for fn in os.listdir(folder):
			if "global" in fn or "range" in fn or not "inear" in fn or 'onst' in fn: # exlude "_2mp_" sine P and F are used separately
				continue
