...
#	style.p2dColorMap = 'YlOrRd'
	...
	if not study == "bigger2pp":
		sectors          = ["1++1+[pi,pi]1--PiS", "2-+1+[pi,pi]1--PiP", "2++1+[pi,pi]1--PiD"]
	else:
		sectors          = ["1++1+[pi,pi]1--PiS", "2-+1+[pi,pi]1--PiP"]
...
#	methodBinRanges = {} # Override here 
	...
	folder = "./comparisonResults_rest"+studyAdder+"/"
