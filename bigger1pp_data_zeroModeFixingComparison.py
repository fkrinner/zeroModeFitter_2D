...
def doFitRhoS(inFileName,zeroFileName, sectors, startBin, stopBin, tBins, sectorRangeMap = {}):
...
def doFitRhoD(inFileName,zeroFileName, sectors, startBin, stopBin, tBins, sectorRangeMap = {}):
	rhoMass  = ptc.parameter( mRho, "rhoMass" )
	rhoWidth = ptc.parameter( Grho , "rhoWidth")
...
#	fitF2 = doFitF2(inFileName,zeroFileName, sectors, startBin, stopBin, tBins)
